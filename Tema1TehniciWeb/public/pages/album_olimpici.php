  ...
  <body>
    ...
    <div class = "_scroll_data_wrapper_">
              <div class = "_details_inf">
                   <div class = "desc_">
                     Colegiul Dobrogean Spiru Haret este unul dintre cele mai bune colegii din judet avand si pregatind anual elevi de exceptie .. 
                   </div>
              </div>
                ...
                <!-- -->
                    <div id="container">
                      <div class="button_container" style="left:0"><span class="button prevButton"></span></div>
                        <ul>
                             <?php
                               foreach(glob("../images/album_olimpici/".'*') as $filename){
                                echo 
                                "
                                <li style='text-align:center'>
                                  <img src = '../images/album_olimpici/".basename($filename)."' height = '600' />
                                </li>
                                ";
                               }
                            ?>
                ...
                <?php
                    foreach(glob("../images/album_olimpici/".'*') as $filename){
                      echo 
                            "
                          <div class = 'thumb'>
                            <img src = '../images/album_olimpici/".basename($filename)."'  />
